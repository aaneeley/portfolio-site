...
<main class="w-screen h-screen flex justify-center items-center px-5">
    ...
    >
        ...
        >
            <button
                class="btn btn-soft btn-circle rounded-full"
                aria-label="asf"
                onclick={() =>
                    window.open("https://github.com/aaneeley", "_blank")}
                ><svg
                    width="20"
                    height="20"
                    viewBox="0 0 15 15"
            ...
            <button
                ...
                onclick={() =>
                    window.open(
                        "https://www.linkedin.com/in/aneeley/",
                        "_blank",
                    )}
                ><svg
                    width="20"
            ...
            <button
                class="btn btn-soft btn-circle rounded-full"
                aria-label="asf"
                onclick={() => window.open("mailto:andrew.neeley@icloud.com")}
                ><svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
